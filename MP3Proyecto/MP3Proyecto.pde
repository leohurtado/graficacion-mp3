...
void setup() {
  ...
  cp5.addSlider("Hpass").setPosition(10, (height/2)+5).setSize(20, 100).setRange(0, 3000).setValue(0).setNumberOfTickMarks(30);  
  cp5.getController("Hpass").getValueLabel().align(ControlP5.RIGHT, ControlP5.BOTTOM_OUTSIDE).setPaddingY(-100);
  cp5.addSlider("Lpass").setPosition(60, (height/2)+5).setSize(20, 100).setRange(3000, 20000).setValue(3000).setNumberOfTickMarks(30);  
  cp5.getController("Lpass").getValueLabel().align(ControlP5.RIGHT, ControlP5.BOTTOM_OUTSIDE).setPaddingY(-100);
  cp5.addSlider("Bpass").setPosition(100, (height/2)+5).setSize(20, 100).setRange(100, 1000).setValue(100).setNumberOfTickMarks(30);
  ...
  list = cp5.addScrollableList("playlist")
            ...
            .setLabel("Lista de reproduccion");
...
void draw() {
  ...
  try {
    ...
    //float timereal = ((song.length()-song.position()/1000)/60);
    ...
    textAlign(CENTER);
    textSize(20);
    text(meta.title(), width/2, height-210);
    textSize(14);
    text(meta.album(), width/2, height-170);
    text(meta.author(), width/2, height-190);
    textSize(10);
  ...
  try{
    ...
    //stroke();
    stroke(mouseX,140,mouseY);
    line( i+5, height/2, i+5, (height - fft.getBand(i)*8)/2);
    }
  } catch(Exception e){}
}
